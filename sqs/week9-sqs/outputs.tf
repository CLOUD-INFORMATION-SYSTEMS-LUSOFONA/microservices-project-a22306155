...
output "product_events_fifo_queue_url" {
  description = "URL of the FIFO product-events queue used for ordered message delivery."
  value       = aws_sqs_queue.product_events_fifo.id
}

output "product_events_fifo_queue_arn" {
  description = "ARN of the FIFO product-events queue."
